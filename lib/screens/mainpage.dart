                              ...
                              if (e.value["posted_by"][2] ==
                                ...
                                return Container(
                                  ...
                                  child: FlipCard(
                                    ...
                                    // back: Container(),
                                    back: Travel_card_back(
                                      displayname: e.value['posted_by'][0],
                                      email: e.value['posted_by'][1],
                                      companions: e.value["companions"],
                                      msg: e.value["Message"],
                                      index: e.key,
                                      callback: resetCards,
                                    ),
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    dur != null
                                                        ? dur!.inDays == 0
                                                            ? Text(
                                                                "${dur!.inHours.remainder(24)}H ${dur!.inMinutes.remainder(60)}M",
                                                                style: TextStyle(
                                                                    fontSize:
                                                                        16,
                                                                    color: Colors
                                                            ...
                                                            : Text(
                                                                "${dur!.inDays}D ${dur!.inHours.remainder(24)}H ${dur!.inMinutes.remainder(60)}M",
                                                                style: TextStyle(
                                                                    fontSize:
                                                                        16,
                                                                    color: Colors
                                                        ...
                                                        return AlertDialog(
                                                          ...
                                                          content:
                                                            ...
                                                            decoration:
                                                                InputDecoration(
                                                              hintText:
                                                                  "You can give info about vehicle such as train no., bus no. and flight",
                                                              hintMaxLines: 3,
                                                            ),
                                                            initialValue:
                                                                message,
