              ...
              Row(
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(widget.displayname,style: TextStyle(fontSize: 17,fontWeight: FontWeight.bold),),
              ...
              Row(
                ...
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Companions",style: TextStyle(fontSize: 20,color: Color(0xFF4F4F4F),fontWeight: FontWeight.bold),),
                      SizedBox(height: 7,),
                      Container(
                        height: 90,
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Message",style: TextStyle(fontSize: 20,color: Color(0xFF4F4F4F),fontWeight: FontWeight.bold),),
                      SizedBox(height: 7,),
                      Container(
                        padding: EdgeInsets.all(10),
                        height: 90,
